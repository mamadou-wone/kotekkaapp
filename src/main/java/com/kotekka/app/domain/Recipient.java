 ...
 */
@Schema(description = "Recipients are phone contacts who will receive Cash directly\nThey are identified by their phone number")
@Entity
...
public class Recipient implements Serializable {
    ...
    public Recipient uuid(UUID uuid) {
        this.setUuid(uuid);
        return this;
    }
    ...
    public Recipient status(DefaultStatus status) {
    ...
    public Recipient walletHolder(UUID walletHolder) {
    ...
    public Recipient createdBy(String createdBy) {
    ...
    public Recipient createdDate(Instant createdDate) {
    ...
    public Recipient lastModifiedBy(String lastModifiedBy) {
    ...
    public Recipient lastModifiedDate(Instant lastModifiedDate) {
