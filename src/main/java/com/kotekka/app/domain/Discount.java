...
public class Discount implements Serializable {
    ...
    public Discount uuid(UUID uuid) {
        this.setUuid(uuid);
        return this;
    }
    ...
    public Discount status(DefaultStatus status) {
    ...
    public Discount createdBy(String createdBy) {
    ...
    public Discount createdDate(Instant createdDate) {
    ...
    public Discount lastModifiedBy(String lastModifiedBy) {
    ...
    public Discount lastModifiedDate(Instant lastModifiedDate) {
