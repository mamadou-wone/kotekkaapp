...
public class FeatureFlag implements Serializable {
    ...
    public FeatureFlag createdBy(String createdBy) {
    ...
    public FeatureFlag createdDate(Instant createdDate) {
    ...
    public FeatureFlag updatedBy(String updatedBy) {
    ...
    public FeatureFlag updatedDate(Instant updatedDate) {
