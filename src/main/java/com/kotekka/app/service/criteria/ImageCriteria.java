...
/**
 * Criteria class for the {@link com.kotekka.app.domain.Image} entity. This class is used
 * in {@link com.kotekka.app.web.rest.ImageResource} to receive all the possible filtering options from
...
public class ImageCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, uuid, name, walletHolder, createdBy, createdDate, lastModifiedBy, lastModifiedDate, distinct);
    }
