...
/**
 * Criteria class for the {@link com.kotekka.app.domain.IncomingCall} entity. This class is used
 * in {@link com.kotekka.app.web.rest.IncomingCallResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /incoming-calls?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class IncomingCallCriteria implements Serializable, Criteria {
    ...
    public IncomingCallCriteria() {}

    public IncomingCallCriteria(IncomingCallCriteria other) {
    ...
    @Override
    public IncomingCallCriteria copy() {
        return new IncomingCallCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final IncomingCallCriteria that = (IncomingCallCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, partner, api, method, createdDate, responseStatusCode, responseTime, distinct);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "IncomingCallCriteria{" +
