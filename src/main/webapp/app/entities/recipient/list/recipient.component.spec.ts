...
import { sampleWithRequiredData } from '../recipient.test-samples';
...
describe('Recipient Management Component', () => {
  ...
  describe('trackId', () => {
    it('Should forward to recipientService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getRecipientIdentifier');
      const id = comp.trackId(entity);
      expect(service.getRecipientIdentifier).toHaveBeenCalledWith(entity);
